...
void BarrierDeathParticle::Initialize(KamataEngine::Model* model, KamataEngine::Camera* camera, KamataEngine::Vector3 position) 
{
	// NULLポイントチェック
	assert(model);
...
void BarrierDeathParticle::Update() 
{
	for (KamataEngine::WorldTransform& worldTransform : WorldTransforms_) 
	{
		// アフィン変換行列
...
void BarrierDeathParticle::Draw()
{
